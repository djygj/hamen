 ...
 * 
 * Disassembly of SSDT6.aml, Wed Nov 26 01:36:47 2014
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000010BD (4285)
 *     Revision         0x01
 *     Checksum         0xAB
 *     OEM ID           "SgRef"
 *     OEM Table ID     "SgPeg"
...
DefinitionBlock ("SSDT6.aml", "SSDT", 1, "SgRef", "SgPeg", 0x00001000)
{
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        Method (SGON, 0, Serialized)
        {
            ...
            Store (One, ONOF)
            And (\_SB.PCI0.PEG0.PEGP.LVL1, 0xFFFBFFFF, \_SB.PCI0.PEG0.PEGP.LVL1)
            Sleep (0x64)
            ECS4 (One)
            Sleep (0x012C)
            Or (\_SB.PCI0.PEG0.PEGP.LVL1, 0x00040000, \_SB.PCI0.PEG0.PEGP.LVL1)
            Sleep (0x64)
