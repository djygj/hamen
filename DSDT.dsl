 ...
 * 
 * Disassembly of DSDT.aml, Wed Nov 26 01:36:47 2014
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00011E62 (73314)
 *     Revision         0x02
 *     Checksum         0x4D
 *     OEM ID           "DELL  "
 *     OEM Table ID     "CBX3   "
...
DefinitionBlock ("DSDT.aml", "DSDT", 2, "DELL  ", "CBX3   ", 0x00000014)
{
    External (LCD_)
    External (AFN1, MethodObj)    // 1 Arguments
    External (AFN0, MethodObj)    // 0 Arguments
    ...
    External (\_SB_.PCI0.I2C1.TPD8.PS0X)
    External (\_SB_.PCI0.I2C1.TPD7.PS0X)
        ...
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                Device (LDRC)
                {
                    ...
                    Method (_CRS, 0, NotSerialized)
                    {
                        CreateWordField (BUF0, \_SB.PCI0.LPCB.LDRC._Y10._MIN, IO0M)
                        CreateWordField (BUF0, \_SB.PCI0.LPCB.LDRC._Y10._MAX, IO0X)
                        Store (GPBS, IO0M)
                        Store (GPBS, IO0X)
                        CreateWordField (BUF0, \_SB.PCI0.LPCB.LDRC._Y11._MIN, IO1M)
                        CreateWordField (BUF0, \_SB.PCI0.LPCB.LDRC._Y11._MAX, IO1X)
                        Store (Add (GPBS, 0x0100), IO1M)
                        Store (Add (GPBS, 0x0100), IO1X)
                        CreateWordField (BUF0, \_SB.PCI0.LPCB.LDRC._Y12._MIN, IO2M)
                        CreateWordField (BUF0, \_SB.PCI0.LPCB.LDRC._Y12._MAX, IO2X)
                        Store (Add (GPBS, 0x0200), IO2M)
                        Store (Add (GPBS, 0x0200), IO2X)
                        CreateWordField (BUF0, \_SB.PCI0.LPCB.LDRC._Y13._MIN, IO3M)
                        CreateWordField (BUF0, \_SB.PCI0.LPCB.LDRC._Y13._MAX, IO3X)
    ...
    Scope (_SB.PCI0)
    {
        ...
        Scope (\_SB.PCI0)
        {
            Device (SIRC)
            {
                ...
                Method (_CRS, 0, NotSerialized)
                {
                    ...
                    CreateDWordField (BUF1, \_SB.PCI0.SIRC._Y14._BAS, BR01)
                    CreateDWordField (BUF2, \_SB.PCI0.SIRC._Y15._BAS, BR02)
                    CreateDWordField (BUF3, \_SB.PCI0.SIRC._Y16._BAS, BR03)
                    CreateDWordField (BUF4, \_SB.PCI0.SIRC._Y17._BAS, BR04)
                    CreateDWordField (BUF5, \_SB.PCI0.SIRC._Y18._BAS, BR05)
                    CreateDWordField (BUF6, \_SB.PCI0.SIRC._Y19._BAS, BR06)
                    CreateDWordField (BUF7, \_SB.PCI0.SIRC._Y1A._BAS, BR07)
                    CreateDWordField (BUF8, \_SB.PCI0.SIRC._Y1B._BAS, BR08)
                    ...
                    If (LNotEqual (BR08, Zero))
                    {
                        ...
                        CreateDWordField (BUFL, \_SB.PCI0.SIRC._Y1C._BAS, LBAS)
                        CreateDWordField (BUFH, \_SB.PCI0.SIRC._Y1D._BAS, HBAS)
                ...
                Method (CNTR, 1, Serialized)
                {
                    ...
                    While (One)
                    {
                        ...
                        If (LEqual (_T_0, One))
                        {
                            CreateDWordField (BUF1, \_SB.PCI0.SIRC._Y14._BAS, BAR1)
                            Return (BAR1)
                        }
                        Else
                        {
                            If (LEqual (_T_0, 0x02))
                            {
                                CreateDWordField (BUF2, \_SB.PCI0.SIRC._Y15._BAS, BAR2)
                                Return (BAR2)
                            }
                            Else
                            {
                                If (LEqual (_T_0, 0x03))
                                {
                                    CreateDWordField (BUF3, \_SB.PCI0.SIRC._Y16._BAS, BAR3)
                                    Return (BAR3)
                                }
                                Else
                                {
                                    If (LEqual (_T_0, 0x04))
                                    {
                                        CreateDWordField (BUF4, \_SB.PCI0.SIRC._Y17._BAS, BAR4)
                                        Return (BAR4)
                                    }
                                    Else
                                    {
                                        If (LEqual (_T_0, 0x05))
                                        {
                                            CreateDWordField (BUF5, \_SB.PCI0.SIRC._Y18._BAS, BAR5)
                                            Return (BAR5)
                                        }
                                        Else
                                        {
                                            If (LEqual (_T_0, 0x06))
                                            {
                                                CreateDWordField (BUF6, \_SB.PCI0.SIRC._Y19._BAS, BAR6)
                                                Return (BAR6)
                                            }
                                            Else
                                            {
                                                If (LEqual (_T_0, 0x07))
                                                {
                                                    CreateDWordField (BUF7, \_SB.PCI0.SIRC._Y1A._BAS, BAR7)
                                                    Return (BAR7)
                                                }
                                                Else
                                                {
                                                    If (LEqual (_T_0, 0x08))
                                                    {
                                                        CreateDWordField (BUF8, \_SB.PCI0.SIRC._Y1B._BAS, BAR8)
                                                        Return (BAR8)
                                                    }
                                                    Else
                                                    {
            ...
            Device (GPI0)
            {
                ...
                CreateDWordField (RBUF, \_SB.PCI0.GPI0._Y1E._MIN, BVAL)
                Method (_STA, 0, NotSerialized)
                {
                    If (LEqual (BVAL, Zero))
                    {
            ...
            Device (SDMA)
            {
                ...
                CreateDWordField (RBUF, \_SB.PCI0.SDMA._Y1F._BAS, BVAL)
                Method (_STA, 0, NotSerialized)
                {
                    If (LEqual (BVAL, Zero))
                    {
            ...
            Device (I2C0)
            {
                ...
                CreateDWordField (RBUF, \_SB.PCI0.I2C0._Y20._BAS, BVAL)
                Method (_STA, 0, NotSerialized)
                {
                    If (LEqual (BVAL, Zero))
                    {
            ...
            Device (I2C1)
            {
                ...
                CreateDWordField (RBUF, \_SB.PCI0.I2C1._Y21._BAS, BVAL)
                Method (_STA, 0, NotSerialized)
                {
                    If (LEqual (BVAL, Zero))
                    {
            ...
            Device (SPI0)
            {
                ...
                CreateDWordField (RBUF, \_SB.PCI0.SPI0._Y22._BAS, BVAL)
                Method (_STA, 0, NotSerialized)
                {
                    If (LEqual (BVAL, Zero))
                    {
            ...
            Device (SPI1)
            {
                ...
                CreateDWordField (RBUF, \_SB.PCI0.SPI1._Y23._BAS, BVAL)
                Method (_STA, 0, NotSerialized)
                {
                    If (LEqual (BVAL, Zero))
                    {
            ...
            Device (UA00)
            {
                ...
                CreateDWordField (RBUF, \_SB.PCI0.UA00._Y24._BAS, BVAL)
                Method (_STA, 0, NotSerialized)
                {
                    If (LEqual (BVAL, Zero))
                    {
            ...
            Device (UA01)
            {
                ...
                CreateDWordField (RBUF, \_SB.PCI0.UA01._Y25._BAS, BVAL)
                Method (_STA, 0, NotSerialized)
                {
                    If (LEqual (BVAL, Zero))
                    {
            ...
            Device (SDHC)
            {
                ...
                CreateDWordField (RBUF, \_SB.PCI0.SDHC._Y26._BAS, BVAL)
                Method (_STA, 0, NotSerialized)
                {
                    If (LEqual (BVAL, Zero))
                    {
        ...
        Scope (I2C1)
        {
            ...
            Device (TPD0)
            {
                ...
                Method (_CRS, 0, Serialized)
                {
                    ...
                    If (LEqual (GR13, One))
                    {
                        CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD0._CRS._Y27._INT, VAL3)
                        Store (0x1B, VAL3)
                    }
            ...
            Device (TPD1)
            {
                ...
                Method (_CRS, 0, Serialized)
                {
                    ...
                    If (LEqual (GR13, One))
                    {
                        CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD1._CRS._Y28._INT, VAL3)
                        Store (0x1B, VAL3)
                    }
            ...
            Device (TPD2)
            {
                ...
                Method (_CRS, 0, Serialized)
                {
                    ...
                    If (LEqual (GR13, One))
                    {
                        CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD2._CRS._Y29._INT, VAL3)
                        Store (0x1B, VAL3)
                    }
            ...
            Device (TPD3)
            {
                ...
                Method (_CRS, 0, Serialized)
                {
                    ...
                    If (LEqual (GR13, One))
                    {
                        CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD3._CRS._Y2A._INT, VAL3)
                        Store (0x1B, VAL3)
                    }
            ...
            Device (TPD7)
            {
                ...
                Method (_CRS, 0, Serialized)
                {
                    ...
                    If (LEqual (GR13, One))
                    {
                        CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD7._CRS._Y2B._INT, VAL3)
                        Store (0x1B, VAL3)
                        If (LEqual (S0ID, Zero))
                        {
            ...
            Device (TPD8)
            {
                ...
                Method (_CRS, 0, Serialized)
                {
                    ...
                    If (LEqual (GR13, One))
                    {
                        CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD8._CRS._Y2C._INT, VAL3)
                        Store (0x1B, VAL3)
                        If (LEqual (S0ID, Zero))
                        {
                            CreateByteField (SBFI, 0x24, VAL4)
        ...
        Scope (SDHC)
        {
            Device (WI01)
            {
                ...
                Method (_CRS, 0, NotSerialized)
                {
                    CreateDWordField (^^RBUF, \_SB.PCI0.SDHC._Y26._BAS, AVAL)
                    If (LNotEqual (AVAL, Zero))
                    {
                        CreateDWordField (RBUF, \_SB.PCI0.SDHC.WI01._Y2D._LEN, WLN0)
                        Store (0x0C, WLN0)
                        CreateDWordField (RBUF, \_SB.PCI0.SDHC.WI01._Y2D._BAS, WVAL)
        ...
        Device (ADSP)
        {
            ...
            Method (_STA, 0, NotSerialized)
            {
                If (LGreaterEqual (OSYS, 0x07DC))
                {
                    If (LEqual (S0ID, One))
                    {
                        CreateDWordField (RBUF, \_SB.PCI0.ADSP._Y2E._BAS, BVAL)
                        If (LEqual (BVAL, Zero))
                        {
                            Return (Zero)
                        }
    ...
    Method (_WAK, 1, Serialized)
    {
        ...
        If (LOr (LOr (LEqual (OSYS, 0x07D2), LEqual (OSYS, 0x07D1)), LEqual (
            Arg0, 0x03)))
        {
            Store (One, USBL)
            If (CAMD)
    ...
    Scope (_SB.PCI0)
    {
        Device (PDRC)
        {
            ...
            Method (_CRS, 0, Serialized)
            {
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y2F._BAS, RBR0)
                ShiftLeft (^^LPCB.RCBA, 0x0E, RBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y30._BAS, TBR0)
                Store (TBAB, TBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y30._LEN, TBLN)
                If (LEqual (TBAB, Zero))
                {
                    Store (Zero, TBLN)
                }

                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y31._BAS, SNR0)
                Store (SRMB, SNR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y32._BAS, MBR0)
                ShiftLeft (MHBR, 0x0F, MBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y33._BAS, DBR0)
                ShiftLeft (DIBR, 0x0C, DBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y34._BAS, EBR0)
                ShiftLeft (EPBR, 0x0C, EBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y35._BAS, XBR0)
                ShiftLeft (PXBR, 0x1A, XBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y35._LEN, XSZ0)
    ...
    Scope (_SB.PCI0.PEG0.PEGP)
    {
        ...
        {
            Store (One, HPEV)
            If (LOr (LEqual (VVID, 0x1002), LEqual (VVID, 0xFFFF)))
            {
                Notify (GFX0, 0xD9)
            }
    ...
    Scope (_GPE)
    {
        ...
        Method (_L01, 0, NotSerialized)
        {
            ...
            If (LAnd (LEqual (RP7D, Zero), \_SB.PCI0.RP07.PDCX))
            {
            ...
            If (LAnd (LEqual (RP8D, Zero), \_SB.PCI0.RP08.PDCX))
            {
    ...
    Scope (_SB.PCI0.LPCB)
    {
        Device (ECDV)
        {
            ...
            Method (_CRS, 0, NotSerialized)
            {
                CreateWordField (ECRS, \_SB.PCI0.LPCB.ECDV._Y36._MIN, DMIN)
                CreateWordField (ECRS, \_SB.PCI0.LPCB.ECDV._Y36._MAX, DMAX)
                CreateWordField (ECRS, \_SB.PCI0.LPCB.ECDV._Y37._MIN, CMIN)
                CreateWordField (ECRS, \_SB.PCI0.LPCB.ECDV._Y37._MAX, CMAX)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        ...
        Device (UAR1)
        {
            ...
            Method (_CRS, 0, Serialized)
            {
                ...
                CreateByteField (BUF0, \_SB.PCI0.LPCB.UAR1._CRS._Y38._MIN, IOL0)
                CreateByteField (BUF0, 0x03, IOH0)
                CreateByteField (BUF0, \_SB.PCI0.LPCB.UAR1._CRS._Y38._MAX, IOL1)
                CreateByteField (BUF0, 0x05, IOH1)
                CreateByteField (BUF0, \_SB.PCI0.LPCB.UAR1._CRS._Y38._LEN, LEN0)
                CreateWordField (BUF0, \_SB.PCI0.LPCB.UAR1._CRS._Y39._INT, IRQW)
                Store (Zero, CR55)
        ...
        Device (LPTE)
        {
            ...
            Method (_CRS, 0, Serialized)
            {
                ...
                If (CLPS ())
                {
                    CreateByteField (BUF0, \_SB.PCI0.LPCB.LPTE._CRS._Y3A._MIN, IOL0)
                    CreateByteField (BUF0, 0x03, IOH0)
                    CreateByteField (BUF0, \_SB.PCI0.LPCB.LPTE._CRS._Y3A._MAX, IOL1)
                    CreateByteField (BUF0, 0x05, IOH1)
                    CreateByteField (BUF0, \_SB.PCI0.LPCB.LPTE._CRS._Y3A._LEN, LEN0)
                    CreateWordField (BUF0, \_SB.PCI0.LPCB.LPTE._CRS._Y3B._INT, IRQW)
                    Store (Zero, CR55)
